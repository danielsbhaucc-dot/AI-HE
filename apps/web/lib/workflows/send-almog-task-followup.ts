...
כתוב טקסט לנוטיפיקציה בלבד: 2–3 משפטים, עד 50 מילים, בלי כותרת, בלי הטפה, בלי "התגעגענו".
  ...
  const completion = await openrouter.chat.completions.create({
    ...
    messages: [
      { role: 'system', content: systemPrompt },
      {
        role: 'user',
        content:
          'כתוב את גוף ההודעה לנוטיפיקציה בלבד. עברית טבעית, גוף אחד (אלמוג), לשון זכר על עצמך.',
      },
    ],
  });
