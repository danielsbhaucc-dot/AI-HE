    ...
    <div>
      ...
      <div style={{
        ...
        <div className="flex gap-3.5 items-center mb-3.5 p-4 animate-pulse"
          style={{ background: 'rgba(255,255,255,0.92)', borderRadius: '22px', border: '1px solid rgba(255,255,255,0.8)', boxShadow: '0 4px 20px rgba(45,27,142,0.08)' }}>
          <div className="w-[58px] h-[58px] rounded-[18px]" style={{ background: 'linear-gradient(145deg, #2D1B8E, #6B5FD4)' }} />
          <div className="flex-1 space-y-2">
            <div className="h-4 w-32 rounded-lg" style={{ background: 'rgba(45,27,142,0.12)' }} />
            <div className="h-3 w-40 rounded-md" style={{ background: 'rgba(45,27,142,0.07)' }} />
            <div className="flex gap-1">
              {[0,1,2,3,4,5].map(i => <div key={i} className="h-1.5 flex-1 rounded-full" style={{ background: 'rgba(45,27,142,0.08)' }} />)}
            </div>
          </div>
        </div>
        ...
        <div className="h-3 w-16 rounded-md mt-4 mb-3 ml-0.5 animate-pulse" style={{ background: 'rgba(45,27,142,0.10)' }} />

        {/* Lesson-card skeletons */}
        {[0, 1, 2].map((i) => (
          <div key={i} className="mb-3.5 overflow-hidden animate-pulse"
            style={{ borderRadius: '22px', boxShadow: '0 4px 20px rgba(45,27,142,0.12)', animationDelay: `${i * 100}ms` }}>
            <div style={{ background: 'linear-gradient(145deg, #1e1260, #3730A3, #6B5FD4)', padding: '18px 16px', display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.97)', padding: '12px 16px' }}>
              <div className="h-3 w-full rounded-md mb-2" style={{ background: 'rgba(45,27,142,0.07)' }} />
              <div className="flex justify-between items-center">
                <div className="h-3 w-20 rounded-md" style={{ background: 'rgba(45,27,142,0.08)' }} />
